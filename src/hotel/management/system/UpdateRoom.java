...
public class UpdateRoom extends JFrame implements ActionListener{
    ...
    UpdateRoom(){
        ...
        tfroom.setBounds(200,130,160,25);
        add(tfroom);
        ...
        tfavailable.setBounds(200,180,160,25);
        add(tfavailable);
        
        JLabel lbltime = new JLabel("Cleaning Status");
        lbltime.setBounds(30,230,100,20);
        add(lbltime);
        
        tfstatus = new JTextField();
        tfstatus.setBounds(200,230,160,25);
        add(tfstatus);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/updateroom.jpeg"));
