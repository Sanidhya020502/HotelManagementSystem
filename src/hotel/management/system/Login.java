...
public class Login extends JFrame implements ActionListener{
    ...
    JTextField username; //declared them globally so that action listner function can access them
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()== login){
            ...
            try{
                ...
                ResultSet rs = c.s.executeQuery(query);  //execute query commands is for reading
